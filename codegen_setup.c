...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Colony Wars",
    .project_root_env = "COLONY_WARS_PROJECT_ROOT",
    .build_dir_env = "COLONY_WARS_BUILD_DIR",
    .force_setup_env = "COLONY_WARS_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_005.43_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Colony_Wars_Recompiled",
    .prepare_note =
